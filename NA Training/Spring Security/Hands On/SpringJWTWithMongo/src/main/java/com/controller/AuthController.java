...
public class AuthController {
	...
	@PostMapping("/signin")
	public ResponseEntity<JSONResponse> validateUser(@Valid @RequestBody LoginRequest loginRequest) {
		...
		return ResponseEntity.ok(new JSONResponse(jwtToken, userDetails.getUsername(), roles));
	}
}